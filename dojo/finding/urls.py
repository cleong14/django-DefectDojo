...
urlpatterns = [
    ...
    # WIP: test-tojo: views.findings == dojo/finding/views.py
    url(r'^product/(?P<pid>\d+)/finding/all$', views.findings, {'view': 'All'},
    ...
    url(r'^engagement/(?P<eid>\d+)/finding/verified$', views.verified_findings,
        name='engagement_verified_findings'),
    url(r'^engagement/(?P<eid>\d+)/finding/accepted$', views.accepted_findings,
        name='engagement_accepted_findings'),
    url(r'^engagement/(?P<eid>\d+)/finding/all$', views.findings, {'view': 'All'},
